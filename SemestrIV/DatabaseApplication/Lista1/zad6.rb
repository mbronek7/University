...
"
DECLARE @a int;
SELECT @a = AVG(SalesLT.SalesOrderDetail.UnitPrice) FROM SalesLT.SalesOrderDetail;

SELECT SalesLT.Customer.LastName, SalesLT.Customer.FirstName, SUM(SalesLT.SalesOrderDetail.UnitPrice) AS Price
...
HAVING SUM(SalesLT.SalesOrderDetail.UnitPrice) > @a
